    ...
    <div className="fixed inset-0 bg-black z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          />
          <h2 className="text-2xl md:text-3xl font-bold gold-text">Age Verification</h2>
        </div>
        ...
        <div className="mb-8">
          ...
          <p className="text-beige text-center mb-6">Please enter your date of birth</p>

          <div className="grid grid-cols-3 gap-4 mb-6">
            <div>
              <label htmlFor="month" className="block text-sm text-beige mb-1">
                Month
              </label>
              <input
                type="number"
                ...
                className="w-full bg-black border border-[#333] focus:border-[#D4AF37] p-3 text-center"
              />
            </div>
            <div>
              <label htmlFor="day" className="block text-sm text-beige mb-1">
                Day
              </label>
              <input
                type="number"
            ...
            <div>
              <label htmlFor="year" className="block text-sm text-beige mb-1">
                Year
              </label>
              <input
                type="number"
        ...
        <div className="flex flex-col space-y-4">
          ...
          <a
            ...
            className="text-center text-beige hover:text-[#D4AF37] text-sm transition-colors"
          >
            I am not 21
          </a>
        </div>
