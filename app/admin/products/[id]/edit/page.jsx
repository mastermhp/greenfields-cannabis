...
const EditProduct = () => {
          ...
          setFormData({
            ...
            images: product.images
              ? product.images.map((url, index) => ({
                  id: `existing-${index}`,
                  url,
                  public_id: product.cloudinaryIds?.[index] || null,
                  existing: true,
                }))
              : [],
            tags: product.tags || [],
  ...
  }, [params.id, accessToken, router, toast])
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          <div className="h-10 w-20 bg-[#333] rounded animate-pulse"></div>
          <div>
            <div className="h-8 w-48 bg-[#333] rounded animate-pulse"></div>
            <div className="h-4 w-64 bg-[#333] rounded animate-pulse mt-2"></div>
          </div>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            {[...Array(2)].map((_, i) => (
              <div key={i} className="bg-[#111] border border-[#333] rounded-lg p-6 animate-pulse">
                <div className="h-6 bg-[#333] rounded w-32 mb-4"></div>
